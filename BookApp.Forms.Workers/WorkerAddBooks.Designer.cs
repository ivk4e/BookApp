namespace BookApp.Forms.Workers
{
	partial class WorkerAddBooks
	{
		...
		private void InitializeComponent()
		{
			...
			addBookButton.Location = new Point(161, 501);
			addBookButton.Name = "addBookButton";
			addBookButton.Size = new Size(147, 32);
			addBookButton.TabIndex = 60;
			...
			label14.Location = new Point(161, 341);
			...
			label7.Location = new Point(611, 451);
			label7.Name = "label7";
			...
			titleBook.Location = new Point(161, 62);
			titleBook.Name = "titleBook";
			titleBook.Size = new Size(653, 25);
			titleBook.TabIndex = 48;
			// 
			// label13
			// 
			...
			label13.Location = new Point(161, 283);
			...
			quantityBox.Location = new Point(161, 301);
			quantityBox.Name = "quantityBox";
			quantityBox.Size = new Size(653, 25);
			quantityBox.TabIndex = 51;
			// 
			// authorImageBox
			// 
			...
			priceBox.Location = new Point(161, 240);
			priceBox.Name = "priceBox";
			priceBox.Size = new Size(653, 25);
			priceBox.TabIndex = 50;
			// 
			// label12
			// 
			...
			label12.Location = new Point(161, 222);
			...
			genreImageBox.Location = new Point(728, 386);
			genreImageBox.Name = "genreImageBox";
			genreImageBox.Size = new Size(64, 60);
			genreImageBox.TabIndex = 52;
			...
			label11.Location = new Point(161, 161);
			...
			genreComboBox.Location = new Point(161, 179);
			genreComboBox.Name = "genreComboBox";
			genreComboBox.Size = new Size(653, 25);
			genreComboBox.TabIndex = 49;
			// 
			// label15
			// 
			label15.AutoSize = true;
			label15.BackColor = Color.FromArgb(241, 227, 203);
			label15.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
			label15.ForeColor = Color.FromArgb(202, 81, 22);
			label15.Location = new Point(720, 451);
			label15.Name = "label15";
			label15.Size = new Size(84, 15);
			label15.TabIndex = 53;
			label15.Text = "Добави жанр";
			// 
			// label10
			// 
			...
			label10.Location = new Point(161, 103);
			...
			descriptionBox.Location = new Point(161, 359);
			...
			label6.Location = new Point(161, 44);
			label6.Name = "label6";
