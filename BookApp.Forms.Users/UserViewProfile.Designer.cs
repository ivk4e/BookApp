namespace BookApp.Forms.Users
{
	partial class UserViewProfile
	{
		...
		private void InitializeComponent()
		{
			...
			button5.Location = new Point(320, 375);
			...
			button6.Location = new Point(320, 423);
			...
			button4.Location = new Point(655, 323);
			...
			label10.Location = new Point(320, 305);
			...
			textBox1.Location = new Point(320, 323);
			...
			button3.Location = new Point(655, 260);
			...
			button2.Location = new Point(655, 198);
			...
			button1.Location = new Point(655, 141);
			...
			label13.Location = new Point(320, 242);
			...
			label7.Location = new Point(320, 123);
			label7.Name = "label7";
			...
			priceBox.Location = new Point(320, 199);
			priceBox.Name = "priceBox";
			priceBox.ReadOnly = true;
			priceBox.Size = new Size(327, 25);
			priceBox.TabIndex = 88;
			// 
			// quantityBox
			// 
			...
			label6.Location = new Point(154, 46);
			label6.Name = "label6";
