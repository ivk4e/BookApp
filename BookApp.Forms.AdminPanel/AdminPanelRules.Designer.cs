namespace BookApp.Forms.AdminPanel
{
	partial class AdminPanelRules
	{
		...
		private void InitializeComponent()
		{
			...
			label6 = new Label();
			label5 = new Label();
			moveToUsersButton = new Button();
			moveToSellersButton = new Button();
			...
			panel1.Controls.Add(moveToUsersButton);
			panel1.Controls.Add(moveToSellersButton);
			panel1.Controls.Add(listBox2);
			panel1.Controls.Add(listBox1);
			panel1.Location = new Point(1, 3);
			panel1.Margin = new Padding(3, 4, 3, 4);
			panel1.Name = "panel1";
			panel1.Size = new Size(979, 743);
			panel1.TabIndex = 0;
			// 
			// label8
			// 
			...
			label6.Location = new Point(224, 72);
			label6.Name = "label6";
			label6.Size = new Size(321, 32);
			label6.TabIndex = 5;
			label6.Text = "Обикновени потребители";
			// 
			// label5
			// 
			...
			// moveToUsersButton
			// 
			moveToUsersButton.Location = new Point(539, 421);
			moveToUsersButton.Margin = new Padding(3, 4, 3, 4);
			moveToUsersButton.Name = "moveToUsersButton";
			moveToUsersButton.Size = new Size(58, 32);
			moveToUsersButton.TabIndex = 3;
			moveToUsersButton.Text = "<-";
			moveToUsersButton.UseVisualStyleBackColor = true;
			// 
			// moveToSellersButton
			// 
			moveToSellersButton.Location = new Point(539, 309);
			moveToSellersButton.Margin = new Padding(3, 4, 3, 4);
			moveToSellersButton.Name = "moveToSellersButton";
			moveToSellersButton.Size = new Size(58, 33);
			moveToSellersButton.TabIndex = 2;
			moveToSellersButton.Text = "->";
			moveToSellersButton.UseVisualStyleBackColor = true;
			// 
			// listBox2
			// 
			listBox2.FormattingEnabled = true;
			listBox2.Location = new Point(621, 121);
			listBox2.Margin = new Padding(3, 4, 3, 4);
			listBox2.Name = "listBox2";
			listBox2.Size = new Size(290, 524);
			listBox2.TabIndex = 1;
			// 
			// listBox1
			// 
			listBox1.FormattingEnabled = true;
			listBox1.Location = new Point(224, 121);
			listBox1.Margin = new Padding(3, 4, 3, 4);
			listBox1.Name = "listBox1";
			listBox1.Size = new Size(290, 524);
			listBox1.TabIndex = 0;
			// 
			// panel5
			// 
			...
			label9.Location = new Point(56, 659);
			label9.Name = "label9";
			...
			exit.Location = new Point(42, 565);
			exit.Margin = new Padding(3, 4, 3, 4);
			exit.Name = "exit";
			exit.Size = new Size(73, 87);
			exit.TabIndex = 6;
			exit.TabStop = false;
			...
			addBooksImageButton.Location = new Point(42, 400);
			addBooksImageButton.Margin = new Padding(3, 4, 3, 4);
			addBooksImageButton.Name = "addBooksImageButton";
			addBooksImageButton.Size = new Size(73, 87);
			...
			label2.Location = new Point(45, 328);
			label2.Name = "label2";
			...
			ordersImageButton.Location = new Point(42, 228);
			ordersImageButton.Margin = new Padding(3, 4, 3, 4);
			ordersImageButton.Name = "ordersImageButton";
			ordersImageButton.Size = new Size(73, 93);
			...
			usersPictureButton.Location = new Point(42, 61);
			usersPictureButton.Margin = new Padding(3, 4, 3, 4);
			usersPictureButton.Name = "usersPictureButton";
			usersPictureButton.Size = new Size(73, 85);
			...
			pictureBox2.Location = new Point(942, 1);
			...
			titleForm.Location = new Point(166, 11);
			titleForm.Name = "titleForm";
			titleForm.Size = new Size(219, 20);
			titleForm.TabIndex = 2;
			titleForm.Text = "Редактиране на потребители";
			// 
			// closeWindowButton
			// 
			closeWindowButton.Location = new Point(0, 0);
			closeWindowButton.Margin = new Padding(3, 4, 3, 4);
			closeWindowButton.Name = "closeWindowButton";
			closeWindowButton.Size = new Size(114, 67);
		...
		private Button moveToUsersButton;
		private Button moveToSellersButton;
