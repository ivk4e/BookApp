namespace BookApp.Forms.AdminPanel
{
	partial class AdminPanelRules
	{
		...
		private void InitializeComponent()
		{
			...
			label11.Location = new Point(544, 77);
			...
			label10.Location = new Point(197, 77);
			...
			// button3
			// 
			button3.Location = new Point(767, 95);
			...
			// button4
			// 
			button4.Location = new Point(717, 95);
			...
			// textBox2
			// 
			textBox2.Location = new Point(544, 95);
			...
			// button1
			// 
			button1.Location = new Point(370, 95);
			...
			// textBox1
			// 
			textBox1.Location = new Point(197, 95);
			...
			label7.Location = new Point(540, 39);
			label7.Name = "label7";
			...
			label6.Location = new Point(194, 39);
			label6.Name = "label6";
			...
			// moveToUsersButton
			// 
			moveToUsersButton.Location = new Point(473, 352);
			moveToUsersButton.Name = "moveToUsersButton";
			moveToUsersButton.Size = new Size(51, 24);
			moveToUsersButton.TabIndex = 3;
			moveToUsersButton.Text = "<-";
			moveToUsersButton.UseVisualStyleBackColor = true;
			moveToUsersButton.Click += moveToUsersButton_Click;
			// 
			// moveToSellersButton
			// 
			moveToSellersButton.Location = new Point(473, 268);
			moveToSellersButton.Name = "moveToSellersButton";
			moveToSellersButton.Size = new Size(51, 25);
			moveToSellersButton.TabIndex = 2;
			moveToSellersButton.Text = "->";
			moveToSellersButton.UseVisualStyleBackColor = true;
			moveToSellersButton.Click += moveToSellersButton_Click;
			// 
			// listBox2
			// 
			listBox2.FormattingEnabled = true;
			listBox2.ItemHeight = 15;
			listBox2.Location = new Point(544, 127);
			listBox2.Name = "listBox2";
			listBox2.Size = new Size(254, 394);
			listBox2.TabIndex = 1;
			...
			listBox1.Location = new Point(197, 127);
			...
			label9.Location = new Point(48, 494);
			label9.Name = "label9";
			...
			pictureBox2.Location = new Point(824, 1);
			...
			titleForm.Size = new Size(175, 15);
			...
			toolStripMenuItem1.Text = "Изтрий";
			toolStripMenuItem1.Click += toolStripMenuItem1_Click;
			// 
			// contextMenuStrip2
			// 
			contextMenuStrip2.Items.AddRange(new ToolStripItem[] { изтрийToolStripMenuItem });
			...
			изтрийToolStripMenuItem.Size = new Size(114, 22);
			изтрийToolStripMenuItem.Text = "Изтрий";
			изтрийToolStripMenuItem.Click += изтрийToolStripMenuItem_Click;
			// 
			// AdminPanelRules
			// 
