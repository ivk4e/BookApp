namespace BookApp.Forms.AdminPanel
{
	partial class AdminPanelAddBook
	{
		...
		private void InitializeComponent()
		{
			...
			((System.ComponentModel.ISupportInitialize)bookImageBox).BeginInit();
			...
			panel1.Controls.Add(bookImageBox);
			...
			addBookButton.Location = new Point(681, 510);
			addBookButton.Name = "addBookButton";
			addBookButton.Size = new Size(147, 32);
			addBookButton.TabIndex = 28;
			...
			label14.Location = new Point(343, 350);
			...
			label13.Location = new Point(343, 292);
			...
			label12.Location = new Point(343, 231);
			...
			label10.Location = new Point(343, 112);
			...
			label9.Location = new Point(343, 53);
			label9.Name = "label9";
			...
			label6.Location = new Point(201, 469);
			label6.Name = "label6";
			...
			genreImageBox.Location = new Point(210, 402);
			genreImageBox.Name = "genreImageBox";
			genreImageBox.Size = new Size(64, 64);
			genreImageBox.TabIndex = 19;
			...
			label7.Location = new Point(200, 348);
			label7.Name = "label7";
			...
			authorImageBox.Location = new Point(210, 279);
			authorImageBox.Name = "authorImageBox";
			authorImageBox.Size = new Size(64, 64);
			...
			quantityBox.Location = new Point(343, 310);
			quantityBox.Name = "quantityBox";
			quantityBox.Size = new Size(485, 25);
			...
			priceBox.Location = new Point(343, 249);
			priceBox.Name = "priceBox";
			priceBox.Size = new Size(485, 25);
			...
			genreComboBox.Location = new Point(343, 188);
			genreComboBox.Name = "genreComboBox";
			genreComboBox.Size = new Size(485, 25);
			...
			titleBook.Location = new Point(343, 71);
			titleBook.Name = "titleBook";
			titleBook.Size = new Size(485, 25);
			titleBook.TabIndex = 14;
			// 
			// uploadImageButton
			// 
			uploadImageButton.Location = new Point(199, 218);
			uploadImageButton.Name = "uploadImageButton";
			uploadImageButton.Size = new Size(111, 23);
			uploadImageButton.TabIndex = 13;
			uploadImageButton.Text = "Upload From PC";
			uploadImageButton.UseVisualStyleBackColor = true;
			// 
			// bookImageBox
			// 
			bookImageBox.BorderStyle = BorderStyle.FixedSingle;
			bookImageBox.Location = new Point(170, 71);
			bookImageBox.Name = "bookImageBox";
			bookImageBox.Size = new Size(140, 140);
			bookImageBox.TabIndex = 12;
			bookImageBox.TabStop = false;
			// 
			// descriptionBox
			// 
			...
			descriptionBox.Location = new Point(343, 368);
			descriptionBox.Name = "descriptionBox";
			descriptionBox.Size = new Size(485, 126);
			...
			authorsComboBox.Location = new Point(343, 130);
			authorsComboBox.Name = "authorsComboBox";
			authorsComboBox.Size = new Size(485, 25);
			...
			label3.Location = new Point(49, 370);
			label3.Name = "label3";
			...
			((System.ComponentModel.ISupportInitialize)bookImageBox).EndInit();
